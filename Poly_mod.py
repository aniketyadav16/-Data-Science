...
feature_2 = st.slider("Select Length Of The Diamond", min_value=0, max_value=100, value=0, step=1)
feature_3 = st.slider("Select Width Of The Diamond", min_value=0, max_value=100, value=0, step=1)
feature_4 = st.slider("Select Depth Of The Diamond", min_value=0, max_value=100, value=0, step=1)
